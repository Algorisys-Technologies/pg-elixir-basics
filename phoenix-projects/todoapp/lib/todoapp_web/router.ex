defmodule TodoappWeb.Router do
  ...
  scope "/", TodoappWeb do
    ...
    # mix phx.gen.html TodoApp Todo todos title:string completed:boolean priority:string
    resources("/todos", TodoController)
    post("/todos/create_comment", TodoController, :create_comment)

    # mix phx.gen.html InventoryApp Inventory inventorys name:string prize:integer game:string
